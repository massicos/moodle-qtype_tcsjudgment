...
Feature: Test duplicating a quiz containing a Concordance of judgment question
  As a teacher
  In order re-use my courses containing Concordance of judgment questions
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | tcsjudgment  | TCS-001  | judgment    |
  ...
  @javascript
  Scenario: Backup and restore a course containing a Concordance of judgment question
